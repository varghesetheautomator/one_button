...
class AdminDataSettings(object):
    """Simple singleton class for managing and accessing datas"""

    def __init__(self):
        with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'admin_data.json')) as f:
...
admin_data_settings = AdminDataSettings()
